...
namespace cryptonote
{
  ...
  {
  public: 
    gpuminer(i_miner_handler* phandler);
    ~gpuminer();
  ...
  private:
    ...
    volatile uint32_t m_threadsperblock;
    std::atomic<int32_t> m_pausers_count;
    epee::critical_section m_gpuminers_count_lock;
