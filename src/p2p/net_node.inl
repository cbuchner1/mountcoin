...
namespace nodetool
{
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("195.12.60.154:9090");
    ADD_HARDCODED_SEED_NODE("192.99.148.104:9090");
    ADD_HARDCODED_SEED_NODE("62.210.125.140:9090");
    ADD_HARDCODED_SEED_NODE("202.112.0.100:9090");
